...
| ------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| Text replies                         | User sends a Page DM and receives a normal assistant reply. Gateway-owned fallback, attachment, and bridged-image copy uses the account-configured Dutch or English language.                                         | Demo a user-initiated DM in the response window with one Dutch and one English account default.                                                 | No extra permission beyond Page messaging; language is static account configuration and requires no profile lookup.   |
...
6. Localized, plan-neutral quota or spend-cap exhaustion copy before an
