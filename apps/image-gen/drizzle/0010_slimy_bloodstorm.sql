...
ALTER TABLE `workspace_entitlement_usage` ADD CONSTRAINT `workspace_entitlement_usage_workspace_id_workspaces_id_fk` FOREIGN KEY (`workspace_id`) REFERENCES `workspaces`(`id`) ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `workspace_entitlement_usage` ADD CONSTRAINT `workspace_entitlement_usage_entitlement_id_workspace_entitlements_id_fk` FOREIGN KEY (`entitlement_id`) REFERENCES `workspace_entitlements`(`id`) ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `workspace_entitlement_usage` ADD CONSTRAINT `workspace_entitlement_usage_source_intent_id_billing_intents_intent_id_fk` FOREIGN KEY (`source_intent_id`) REFERENCES `billing_intents`(`intent_id`) ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `workspace_entitlement_usage_reservations` ADD CONSTRAINT `workspace_entitlement_usage_reservations_workspace_id_workspaces_id_fk` FOREIGN KEY (`workspace_id`) REFERENCES `workspaces`(`id`) ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `workspace_entitlement_usage_reservations` ADD CONSTRAINT `workspace_entitlement_usage_reservations_entitlement_id_workspace_entitlements_id_fk` FOREIGN KEY (`entitlement_id`) REFERENCES `workspace_entitlements`(`id`) ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
